 ...
 */
    const int Menu::MAIN_MENU = 0;
        ...
        const int Menu::SEARCH_DEFINITIONS_MENU = 5;
            ...
            const int Menu::ENABLE_AIRLINE_MENU = 15;
        ...
        switch(menuState.top()) {
            ...
            case 0: mainMenu(); break;
                ...
                case 5: searchDefinitionsMenu(); break;
                    ...
                    case 15: enableAirlineMenu(); break;
...
void Menu::searchDefinitionsMenu() {
    ...
    cout << "│  3 - Enable Airline                │" << endl;
    cout << "│  4 - Change Max Stops              │" << endl;
    cout << "│  5 - Reset Search Settings         │" << endl;
    cout << "│  6 - Go Back                       │" << endl;
    cout << "├────────────────────────────────────┘" << endl;
    ...
    switch(option){
        ...
        case 3: menuState.push(ENABLE_AIRLINE_MENU); break;
        case 4: menuState.push(CHANGE_MAX_AIRPORTS); break;
        case 5: menuState.pop(); skyLines.reset(); break;
...
void Menu::changeMaxStops() {
    ...
    cin >> max;
    while (max <= 1) {
        cout << "│  Min number of airports that can " << endl << "be in a flight path is 2!" << endl;
        cout << "│  Max number of airports" << endl << "that you want to stop at  > ";
        cin >> max;
    }
...
void Menu::listAirports() {
    ...
    while (page != numPages + 1 && page != 0) {
        ...
        cout << "├─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤" << endl;
        cout << "│ page: " << setfill('0') << setw(3) << page << setfill(' ') <<  " of " << numPages << right << setw(103) << "│" << endl;
        cout << "├─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤" << endl;
        cout << "│  Code   Name                                                  City                       Country                    │" << endl;
        cout << "│  ----   ----                                                  ----                       -------                    │" << endl;

        for (auto idx = nodes.begin() + ((page - 1) * 20); idx != nodes.begin() + (page * 20); idx++) {
            cout << "│  " << left << setw(5) << idx->code << "  " << left << setw(52) << idx->name << "  " << left << setw(25) << idx->city << "  " << left << setw(25) << idx->country << "  │" << endl;
        }
